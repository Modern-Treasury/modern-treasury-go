...
func (r *LedgerAccountStatementService) New(ctx context.Context, body LedgerAccountStatementNewParams, opts ...option.RequestOption) (res *LedgerAccountStatement, err error) {
...
func (r *LedgerAccountStatementService) Get(ctx context.Context, id string, opts ...option.RequestOption) (res *LedgerAccountStatement, err error) {
	opts = slices.Concat(r.Options, opts)
	if id == "" {
...
type LedgerAccountStatement struct {
	...
	JSON            ledgerAccountStatementJSON `json:"-"`
}

// ledgerAccountStatementJSON contains the JSON metadata for the struct
// [LedgerAccountStatement]
type ledgerAccountStatementJSON struct {
	ID                         apijson.Field
...
func (r *LedgerAccountStatement) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r ledgerAccountStatementJSON) RawJSON() string {
	return r.raw
}
