...
type LedgerEventHandlerNewResponseLedgerTransactionTemplate struct {
	...
	LedgerEntries []LedgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntries `json:"ledger_entries,required"`
	// Additional data represented as key-value pairs. Both the key and value must be
	// strings.
	Metadata map[string]string `json:"metadata,required,nullable"`
...
type LedgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntries struct {
	// The field you're fetching from the `ledgerable_event`.
	...
	JSON            ledgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntriesJSON
}

// ledgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntriesJSON contains
// the JSON metadata for the struct
// [LedgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntries]
type ledgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntriesJSON struct {
...
func (r *LedgerEventHandlerNewResponseLedgerTransactionTemplateLedgerEntries) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type LedgerEventHandlerGetResponseLedgerTransactionTemplate struct {
	...
	EffectiveAt string `json:"effective_at,required,nullable" format:"datetime"`
	// An array of ledger entry objects.
	LedgerEntries []LedgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntries `json:"ledger_entries,required"`
	// Additional data represented as key-value pairs. Both the key and value must be
	// strings.
	Metadata map[string]string `json:"metadata,required,nullable"`
...
type LedgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntries struct {
	// The field you're fetching from the `ledgerable_event`.
	Amount string `json:"amount,required"`
	// What the operator between the `field` and `value` is. Currently only supports
	// `equals`.
	...
	// What raw string you are comparing the `field` against.
	LedgerAccountID string `json:"ledger_account_id,required"`
	JSON            ledgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntriesJSON
}

// ledgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntriesJSON contains
// the JSON metadata for the struct
// [LedgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntries]
type ledgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntriesJSON struct {
	Amount          apijson.Field
	Direction       apijson.Field
	LedgerAccountID apijson.Field
	raw             string
...
func (r *LedgerEventHandlerGetResponseLedgerTransactionTemplateLedgerEntries) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type LedgerEventHandlerListResponseLedgerTransactionTemplate struct {
	...
	EffectiveAt string `json:"effective_at,required,nullable" format:"datetime"`
	// An array of ledger entry objects.
	LedgerEntries []LedgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntries `json:"ledger_entries,required"`
	// Additional data represented as key-value pairs. Both the key and value must be
	// strings.
	Metadata map[string]string `json:"metadata,required,nullable"`
...
type LedgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntries struct {
	// The field you're fetching from the `ledgerable_event`.
	Amount string `json:"amount,required"`
	// What the operator between the `field` and `value` is. Currently only supports
	// `equals`.
	...
	// What raw string you are comparing the `field` against.
	LedgerAccountID string `json:"ledger_account_id,required"`
	JSON            ledgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntriesJSON
}

// ledgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntriesJSON
// contains the JSON metadata for the struct
// [LedgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntries]
type ledgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntriesJSON struct {
	Amount          apijson.Field
	Direction       apijson.Field
	LedgerAccountID apijson.Field
	raw             string
...
func (r *LedgerEventHandlerListResponseLedgerTransactionTemplateLedgerEntries) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type LedgerEventHandlerDeleteResponseLedgerTransactionTemplate struct {
	...
	EffectiveAt string `json:"effective_at,required,nullable" format:"datetime"`
	// An array of ledger entry objects.
	LedgerEntries []LedgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntries `json:"ledger_entries,required"`
	// Additional data represented as key-value pairs. Both the key and value must be
	// strings.
	Metadata map[string]string `json:"metadata,required,nullable"`
...
type LedgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntries struct {
	// The field you're fetching from the `ledgerable_event`.
	Amount string `json:"amount,required"`
	// What the operator between the `field` and `value` is. Currently only supports
	// `equals`.
	...
	// What raw string you are comparing the `field` against.
	LedgerAccountID string `json:"ledger_account_id,required"`
	JSON            ledgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntriesJSON
}

// ledgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntriesJSON
// contains the JSON metadata for the struct
// [LedgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntries]
type ledgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntriesJSON struct {
	Amount          apijson.Field
	Direction       apijson.Field
	LedgerAccountID apijson.Field
	raw             string
...
func (r *LedgerEventHandlerDeleteResponseLedgerTransactionTemplateLedgerEntries) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
