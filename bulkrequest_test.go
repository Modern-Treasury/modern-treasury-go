...
func TestBulkRequestNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.BulkRequests.New(context.TODO(), moderntreasury.BulkRequestNewParams{
    ...
    Resources: moderntreasury.F([]moderntreasury.BulkRequestNewParamsResourceUnion{moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequest{
      ...
      LineItems: moderntreasury.F([]moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestLineItem{moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestLineItem{
        Amount: moderntreasury.F(int64(0)),
      ...
      ReceivingAccount: moderntreasury.F(moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestReceivingAccount{
        AccountDetails: moderntreasury.F([]moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestReceivingAccountAccountDetail{moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestReceivingAccountAccountDetail{
        ...
        RoutingDetails: moderntreasury.F([]moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestReceivingAccountRoutingDetail{moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestReceivingAccountRoutingDetail{
      ...
      UltimateOriginatingPartyAddress: moderntreasury.F(moderntreasury.BulkRequestNewParamsResourcesPaymentOrderAsyncCreateRequestUltimateOriginatingPartyAddress{
        Country: moderntreasury.F("country"),
        Line1: moderntreasury.F("line1"),
        Line2: moderntreasury.F("line2"),
        Locality: moderntreasury.F("locality"),
