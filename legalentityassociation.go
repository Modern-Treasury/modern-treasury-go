...
type LegalEntityAssociationChildLegalEntity struct {
	...
	BankSettings LegalEntityAssociationChildLegalEntity          `json:"bank_settings,required,nullable"`
	...
	UpdatedAt                  time.Time                              `json:"updated_at,required" format:"date-time"`
	WealthAndEmploymentDetails LegalEntityAssociationChildLegalEntity `json:"wealth_and_employment_details,required,nullable"`
