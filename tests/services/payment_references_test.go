...
func TestPaymentReferenceListWithOptionalParams(t *testing.T) {
	...
	_, err := c.PaymentReferences.List(context.TODO(), &requests.PaymentReferenceListParams{AfterCursor: moderntreasury.F("string"), PerPage: moderntreasury.F(int64(0)), ReferenceableID: moderntreasury.F("string"), ReferenceableType: moderntreasury.F(requests.PaymentReferenceListParamsReferenceableTypePaymentOrder), ReferenceNumber: moderntreasury.F("string")})
	if err != nil {
