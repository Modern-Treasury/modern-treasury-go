...
func TestCounterpartyNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Counterparties.New(context.TODO(), moderntreasury.CounterpartyNewParams{
		...
		LegalEntity: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntity{
			...
			Prefix:                   moderntreasury.F("prefix"),
			PrimarySocialMediaSites:  moderntreasury.F([]string{"string"}),
			Regulators: moderntreasury.F([]moderntreasury.CounterpartyNewParamsLegalEntityRegulator{{
				Jurisdiction:       moderntreasury.F("jurisdiction"),
				Name:               moderntreasury.F("name"),
				RegistrationNumber: moderntreasury.F("registration_number"),
			}}),
			...
			ThirdPartyVerification: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerification{
				Outcome:              moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}),
			ThirdPartyVerifications: moderntreasury.F([]moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerification{{
				Outcome:              moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationsOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationsVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityThirdPartyVerificationsVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}}),
