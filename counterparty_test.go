...
func TestCounterpartyNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Counterparties.New(context.TODO(), moderntreasury.CounterpartyNewParams{
		...
		LegalEntity: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntity{
			...
			BankSettings: moderntreasury.F(shared.BankSettingsParam{
			...
			LegalEntityAssociations: moderntreasury.F([]moderntreasury.CounterpartyNewParamsLegalEntityLegalEntityAssociation{{
				...
				ChildLegalEntity: moderntreasury.F(shared.ChildLegalEntityCreateParam{
					...
					WealthAndEmploymentDetails: moderntreasury.F(shared.WealthAndEmploymentDetailsParam{
						ID:               moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
						...
						EmploymentStatus: moderntreasury.F(shared.WealthAndEmploymentDetailsEmploymentStatusEmployed),
						IncomeCountry:    moderntreasury.F("income_country"),
						IncomeSource:     moderntreasury.F(shared.WealthAndEmploymentDetailsIncomeSourceFamilySupport),
						IncomeState:      moderntreasury.F("income_state"),
						Industry:         moderntreasury.F(shared.WealthAndEmploymentDetailsIndustryAccounting),
						LiveMode:         moderntreasury.F(true),
						Object:           moderntreasury.F("object"),
						Occupation:       moderntreasury.F(shared.WealthAndEmploymentDetailsOccupationConsulting),
						SourceOfFunds:    moderntreasury.F(shared.WealthAndEmploymentDetailsSourceOfFundsAlimony),
						UpdatedAt:        moderntreasury.F(time.Now()),
						WealthSource:     moderntreasury.F(shared.WealthAndEmploymentDetailsWealthSourceBusinessSale),
					}),
