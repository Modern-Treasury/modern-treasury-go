...
func TestCounterpartyNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Counterparties.New(context.TODO(), moderntreasury.CounterpartyNewParams{
		...
		LegalEntity: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntity{
			...
			BankSettings: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntity{
			...
			Suffix:                   moderntreasury.F("suffix"),
			WealthAndEmploymentDetails: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntity{
				ID:               moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				AnnualIncome:     moderntreasury.F(int64(0)),
				CreatedAt:        moderntreasury.F(time.Now()),
				DiscardedAt:      moderntreasury.F(time.Now()),
				...
				EmployerName:     moderntreasury.F("employer_name"),
				EmployerState:    moderntreasury.F("employer_state"),
				EmploymentStatus: moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityEmploymentStatusEmployed),
				IncomeCountry:    moderntreasury.F("income_country"),
				IncomeSource:     moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityIncomeSourceFamilySupport),
				IncomeState:      moderntreasury.F("income_state"),
				Industry:         moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityIndustryAccounting),
				LiveMode:         moderntreasury.F(true),
				Object:           moderntreasury.F("object"),
				Occupation:       moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityOccupationConsulting),
				SourceOfFunds:    moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntitySourceOfFundsAlimony),
				UpdatedAt:        moderntreasury.F(time.Now()),
				WealthSource:     moderntreasury.F(moderntreasury.CounterpartyNewParamsLegalEntityWealthSourceBusinessSale),
			}),
			Website: moderntreasury.F("website"),
		}),
