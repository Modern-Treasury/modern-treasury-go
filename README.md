...
```sh
go get -u 'github.com/Modern-Treasury/modern-treasury-go/v2@v2.1.0'
```
...
The full API of this library can be found in [api.md](https://www.github.com/Modern-Treasury/modern-treasury-go/blob/main/api.md).
