...
// RequestOption is an option for the requests made by the Modern Treasury API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/Modern-Treasury/modern-treasury-go/v2#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://app.moderntreasury.com/")
}
