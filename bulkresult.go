...
type BulkResult struct {
	...
	// `request_params`.
	Entity BulkResultEntity `json:"entity" api:"required"`
	...
	EntityType BulkResultEntityType `json:"entity_type" api:"required"`
	...
	// bulk_request
	RequestParams map[string]string `json:"request_params" api:"required,nullable"`
	// The type of the request that created this result. bulk_request is the only
	// supported `request_type`
	RequestType BulkResultRequestType `json:"request_type" api:"required"`
	// One of successful or failed.
	Status    BulkResultStatus `json:"status" api:"required"`
...
type BulkResultEntity struct {
	...
	AccountingCategoryID string `json:"accounting_category_id" api:"nullable" format:"uuid"`
	...
	AmountLowerBound int64 `json:"amount_lower_bound" api:"nullable"`
	// The amount reconciled for this expected payment. Value in specified currency's
	// smallest unit. e.g. $10 would be represented as 1000.
	AmountReconciled int64 `json:"amount_reconciled" api:"nullable"`
	...
	// debit amount.
	AmountUnreconciledDirection BulkResultEntityAmountUnreconciledDirection `json:"amount_unreconciled_direction" api:"nullable"`
	// The highest amount this expected payment may be equal to. Value in specified
	// currency's smallest unit. e.g. $10 would be represented as 1000.
	AmountUpperBound int64 `json:"amount_upper_bound" api:"nullable"`
	...
	ArchivedReason string `json:"archived_reason" api:"nullable"`
	// The date on which the transaction occurred.
	AsOfDate time.Time `json:"as_of_date" api:"nullable" format:"date"`
	...
	AsOfTime string `json:"as_of_time" api:"nullable" format:"time"`
	// The timezone in which the `as_of_time` is represented. Can be `null` if the bank
	// does not provide timezone info.
	AsOfTimezone string `json:"as_of_timezone" api:"nullable"`
	...
	ChargeBearer BulkResultEntityChargeBearer `json:"charge_bearer" api:"nullable"`
	...
	Currency shared.Currency `json:"currency" api:"nullable"`
	...
	// object's data.
	CurrentReturn ReturnObject `json:"current_return" api:"nullable"`
	...
	ForeignExchangeContract string `json:"foreign_exchange_contract" api:"nullable"`
	// Indicates the type of FX transfer to initiate, can be either
	// `variable_to_fixed`, `fixed_to_variable`, or `null` if the payment order
	// currency matches the originating account currency.
	ForeignExchangeIndicator BulkResultEntityForeignExchangeIndicator `json:"foreign_exchange_indicator" api:"nullable"`
	// Associated serialized foreign exchange rate information.
	ForeignExchangeRate shared.ForeignExchangeRate `json:"foreign_exchange_rate" api:"nullable"`
	// The ID of the Internal Account for the expected payment.
	InternalAccountID string `json:"internal_account_id" api:"nullable" format:"uuid"`
	...
	LedgerTransactionID string `json:"ledger_transaction_id" api:"nullable" format:"uuid"`
	// If the ledger transaction can be reconciled to another object in Modern
	// Treasury, the id will be populated here, otherwise null.
	LedgerableID string `json:"ledgerable_id" api:"nullable" format:"uuid"`
	// If the ledger transaction can be reconciled to another object in Modern
	// Treasury, the type will be populated here, otherwise null. This can be one of
	// payment_order, incoming_payment_detail, expected_payment, return, or reversal.
	LedgerableType BulkResultEntityLedgerableType `json:"ledgerable_type" api:"nullable"`
	...
	// timestamp.
	ProcessAfter time.Time `json:"process_after" api:"nullable" format:"date-time"`
	...
	// is unreconciled.
	ReconciliationMethod BulkResultEntityReconciliationMethod `json:"reconciliation_method" api:"nullable"`
	...
	ReversedByLedgerTransactionID string `json:"reversed_by_ledger_transaction_id" api:"nullable"`
	// The ID of the original ledger transaction that this ledger transaction reverses.
	ReversesLedgerTransactionID string `json:"reverses_ledger_transaction_id" api:"nullable"`
	// Send an email to the counterparty when the payment order is sent to the bank. If
	// `null`, `send_remittance_advice` on the Counterparty is used.
	SendRemittanceAdvice bool `json:"send_remittance_advice" api:"nullable"`
	...
	// characters.
	StatementDescriptor string `json:"statement_descriptor" api:"nullable"`
	...
	Subtype PaymentOrderSubtype `json:"subtype" api:"nullable"`
	// The ID of the Transaction this expected payment object has been matched to.
	TransactionID string `json:"transaction_id" api:"nullable" format:"uuid"`
	...
	// `internal_account`.
	UltimateOriginatingAccountID   string                                         `json:"ultimate_originating_account_id" api:"nullable" format:"uuid"`
	UltimateOriginatingAccountType BulkResultEntityUltimateOriginatingAccountType `json:"ultimate_originating_account_type" api:"nullable"`
	// Identifier of the ultimate originator of the payment order.
	UltimateOriginatingPartyIdentifier string `json:"ultimate_originating_party_identifier" api:"nullable"`
	// Name of the ultimate originator of the payment order.
	UltimateOriginatingPartyName     string `json:"ultimate_originating_party_name" api:"nullable"`
	UltimateReceivingPartyIdentifier string `json:"ultimate_receiving_party_identifier" api:"nullable"`
	UltimateReceivingPartyName       string `json:"ultimate_receiving_party_name" api:"nullable"`
	// This field can have the runtime type of [interface{}].
	...
	VendorFailureReason string `json:"vendor_failure_reason" api:"nullable"`
	// An identifier given to this transaction by the bank.
	VendorID string               `json:"vendor_id" api:"nullable"`
...
type BulkResultEntityBulkError struct {
	...
	LiveMode      bool                                    `json:"live_mode" api:"required"`
	Object        string                                  `json:"object" api:"required"`
	RequestErrors []BulkResultEntityBulkErrorRequestError `json:"request_errors" api:"required"`
	UpdatedAt     time.Time                               `json:"updated_at" api:"required" format:"date-time"`
...
const (
	...
	BulkResultEntityVendorCodeTypeCoinbasePrime   BulkResultEntityVendorCodeType = "coinbase_prime"
