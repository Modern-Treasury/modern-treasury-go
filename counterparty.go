...
const (
	CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipTypeAuthorizedSigner CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipType = "authorized_signer"
...
func (r CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipType) IsKnown() bool {
	switch r {
	case CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipTypeAuthorizedSigner, CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipTypeBeneficialOwner, CounterpartyNewParamsLegalEntityLegalEntityAssociationsRelationshipTypeControlPerson:
		return true
	}
	return false
}
