...
const (
	...
	ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeGeneric                   ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentType = "generic"
...
func (r ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentType) IsKnown() bool {
	switch r {
	case ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeArticlesOfIncorporation, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeCertificateOfGoodStanding, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeEinLetter, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeGeneric, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeIdentificationBack, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeIdentificationFront, ConnectionLegalEntityNewParamsLegalEntityDocumentsDocumentTypeProofOfAddress:
		return true
	}
	return false
}
