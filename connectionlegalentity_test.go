	...
	_, err := client.ConnectionLegalEntities.New(context.TODO(), moderntreasury.ConnectionLegalEntityNewParams{
		...
		LegalEntity: moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntity{
			...
			ThirdPartyVerification: moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerification{
				Outcome:              moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}),
			ThirdPartyVerifications: moderntreasury.F([]moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerification{{
				Outcome:              moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationsOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationsVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.ConnectionLegalEntityNewParamsLegalEntityThirdPartyVerificationsVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}}),
