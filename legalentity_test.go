...
func TestLegalEntityNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.LegalEntities.New(context.TODO(), moderntreasury.LegalEntityNewParams{
		...
		Documents: moderntreasury.F([]moderntreasury.LegalEntityNewParamsDocument{{
			DocumentType: moderntreasury.F(moderntreasury.LegalEntityNewParamsDocumentsDocumentTypeArticlesOfIncorporation),
		...
		LegalEntityAssociations: moderntreasury.F([]shared.LegalEntityAssociationInlineCreateParam{{
			...
			ChildLegalEntity: moderntreasury.F(shared.ChildLegalEntityCreateParam{
				...
				ThirdPartyVerification: moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationParam{
					Outcome:              moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationOutcomePassed),
					...
					VerificationCategory: moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationVerificationCategoryLegalName),
				...
				ThirdPartyVerifications: moderntreasury.F([]shared.ChildLegalEntityCreateThirdPartyVerificationParam{{
					Outcome:              moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationsOutcomePassed),
					Vendor:               moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationsVendorPersona),
					VendorVerificationID: moderntreasury.F("vendor_verification_id"),
					VerificationCategory: moderntreasury.F(shared.ChildLegalEntityCreateThirdPartyVerificationsVerificationCategoryLegalName),
					VerificationMethod:   moderntreasury.F("verification_method"),
					VerificationTime:     moderntreasury.F(time.Now()),
					Comment:              moderntreasury.F("comment"),
				}}),
		...
		ThirdPartyVerification: moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerification{
			Outcome:              moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationOutcomePassed),
			Vendor:               moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationVendorPersona),
			VendorVerificationID: moderntreasury.F("vendor_verification_id"),
			VerificationCategory: moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationVerificationCategoryLegalName),
			VerificationMethod:   moderntreasury.F("verification_method"),
			VerificationTime:     moderntreasury.F(time.Now()),
			Comment:              moderntreasury.F("comment"),
		}),
		ThirdPartyVerifications: moderntreasury.F([]moderntreasury.LegalEntityNewParamsThirdPartyVerification{{
			Outcome:              moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationsOutcomePassed),
			Vendor:               moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationsVendorPersona),
			VendorVerificationID: moderntreasury.F("vendor_verification_id"),
			VerificationCategory: moderntreasury.F(moderntreasury.LegalEntityNewParamsThirdPartyVerificationsVerificationCategoryLegalName),
			VerificationMethod:   moderntreasury.F("verification_method"),
			VerificationTime:     moderntreasury.F(time.Now()),
			Comment:              moderntreasury.F("comment"),
		}}),
	...
	_, err := client.LegalEntities.Update(
		...
		moderntreasury.LegalEntityUpdateParams{
			...
			ThirdPartyVerification: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerification{
				Outcome:              moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}),
			ThirdPartyVerifications: moderntreasury.F([]moderntreasury.LegalEntityUpdateParamsThirdPartyVerification{{
				Outcome:              moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationsOutcomePassed),
				Vendor:               moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationsVendorPersona),
				VendorVerificationID: moderntreasury.F("vendor_verification_id"),
				VerificationCategory: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsThirdPartyVerificationsVerificationCategoryLegalName),
				VerificationMethod:   moderntreasury.F("verification_method"),
				VerificationTime:     moderntreasury.F(time.Now()),
				Comment:              moderntreasury.F("comment"),
			}}),
