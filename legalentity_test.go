...
func TestLegalEntityNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.LegalEntities.New(context.TODO(), moderntreasury.LegalEntityNewParams{
    ...
    Documents: moderntreasury.F([]moderntreasury.LegalEntityNewParamsDocument{moderntreasury.LegalEntityNewParamsDocument{
    ...
    MiddleName: moderntreasury.F("middle_name"),
    OperatingJurisdictions: moderntreasury.F([]string{"string"}),
    PhoneNumbers: moderntreasury.F([]moderntreasury.LegalEntityNewParamsPhoneNumber{moderntreasury.LegalEntityNewParamsPhoneNumber{
      PhoneNumber: moderntreasury.F("phone_number"),
    }}),
    PoliticallyExposedPerson: moderntreasury.F(true),
    PreferredName: moderntreasury.F("preferred_name"),
    Prefix: moderntreasury.F("prefix"),
    PrimarySocialMediaSites: moderntreasury.F([]string{"string"}),
    Regulators: moderntreasury.F([]moderntreasury.LegalEntityNewParamsRegulator{moderntreasury.LegalEntityNewParamsRegulator{
      Jurisdiction: moderntreasury.F("jurisdiction"),
      Name: moderntreasury.F("name"),
      RegistrationNumber: moderntreasury.F("registration_number"),
    }}),
...
func TestLegalEntityUpdateWithOptionalParams(t *testing.T) {
  ...
  _, err := client.LegalEntities.Update(
    ...
    moderntreasury.LegalEntityUpdateParams{
      ...
      MiddleName: moderntreasury.F("middle_name"),
      OperatingJurisdictions: moderntreasury.F([]string{"string"}),
      PhoneNumbers: moderntreasury.F([]moderntreasury.LegalEntityUpdateParamsPhoneNumber{moderntreasury.LegalEntityUpdateParamsPhoneNumber{
        PhoneNumber: moderntreasury.F("phone_number"),
      }}),
      PoliticallyExposedPerson: moderntreasury.F(true),
      PreferredName: moderntreasury.F("preferred_name"),
      Prefix: moderntreasury.F("prefix"),
      PrimarySocialMediaSites: moderntreasury.F([]string{"string"}),
      Regulators: moderntreasury.F([]moderntreasury.LegalEntityUpdateParamsRegulator{moderntreasury.LegalEntityUpdateParamsRegulator{
        Jurisdiction: moderntreasury.F("jurisdiction"),
        Name: moderntreasury.F("name"),
        RegistrationNumber: moderntreasury.F("registration_number"),
      }}),
