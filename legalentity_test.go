...
func TestLegalEntityNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.LegalEntities.New(context.TODO(), moderntreasury.LegalEntityNewParams{
		...
		BankSettings: moderntreasury.F(moderntreasury.LegalEntityNewParamsBankSettings{
		...
		Suffix:                   moderntreasury.F("suffix"),
		WealthAndEmploymentDetails: moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetails{
			ID:               moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			AnnualIncome:     moderntreasury.F(int64(0)),
			CreatedAt:        moderntreasury.F(time.Now()),
			DiscardedAt:      moderntreasury.F(time.Now()),
			...
			EmployerName:     moderntreasury.F("employer_name"),
			EmployerState:    moderntreasury.F("employer_state"),
			EmploymentStatus: moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsEmploymentStatusEmployed),
			IncomeCountry:    moderntreasury.F("income_country"),
			IncomeSource:     moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsIncomeSourceFamilySupport),
			IncomeState:      moderntreasury.F("income_state"),
			Industry:         moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsIndustryAccounting),
			LiveMode:         moderntreasury.F(true),
			Object:           moderntreasury.F("object"),
			Occupation:       moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsOccupationConsulting),
			SourceOfFunds:    moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsSourceOfFundsAlimony),
			UpdatedAt:        moderntreasury.F(time.Now()),
			WealthSource:     moderntreasury.F(moderntreasury.LegalEntityNewParamsWealthAndEmploymentDetailsWealthSourceBusinessSale),
		}),
		Website: moderntreasury.F("website"),
	})
	if err != nil {
...
func TestLegalEntityUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.LegalEntities.Update(
		...
		moderntreasury.LegalEntityUpdateParams{
			...
			BankSettings: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsBankSettings{
				ID:                          moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				BackupWithholdingPercentage: moderntreasury.F(int64(0)),
				CreatedAt:                   moderntreasury.F(time.Now()),
				DiscardedAt:                 moderntreasury.F(time.Now()),
			...
			Suffix:                   moderntreasury.F("suffix"),
			WealthAndEmploymentDetails: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetails{
				ID:               moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				AnnualIncome:     moderntreasury.F(int64(0)),
				CreatedAt:        moderntreasury.F(time.Now()),
				DiscardedAt:      moderntreasury.F(time.Now()),
				...
				EmployerName:     moderntreasury.F("employer_name"),
				EmployerState:    moderntreasury.F("employer_state"),
				EmploymentStatus: moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsEmploymentStatusEmployed),
				IncomeCountry:    moderntreasury.F("income_country"),
				IncomeSource:     moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsIncomeSourceFamilySupport),
				IncomeState:      moderntreasury.F("income_state"),
				Industry:         moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsIndustryAccounting),
				LiveMode:         moderntreasury.F(true),
				Object:           moderntreasury.F("object"),
				Occupation:       moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsOccupationConsulting),
				SourceOfFunds:    moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsSourceOfFundsAlimony),
				UpdatedAt:        moderntreasury.F(time.Now()),
				WealthSource:     moderntreasury.F(moderntreasury.LegalEntityUpdateParamsWealthAndEmploymentDetailsWealthSourceBusinessSale),
			}),
			Website: moderntreasury.F("website"),
		},
	)
