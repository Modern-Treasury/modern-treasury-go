...
const (
	...
	RoutingNumberLookupRequestSupportedPaymentTypeStablecoin  RoutingNumberLookupRequestSupportedPaymentType = "stablecoin"
...
func (r RoutingNumberLookupRequestSupportedPaymentType) IsKnown() bool {
	switch r {
	case RoutingNumberLookupRequestSupportedPaymentTypeACH, RoutingNumberLookupRequestSupportedPaymentTypeAuBecs, RoutingNumberLookupRequestSupportedPaymentTypeBacs, RoutingNumberLookupRequestSupportedPaymentTypeBook, RoutingNumberLookupRequestSupportedPaymentTypeCard, RoutingNumberLookupRequestSupportedPaymentTypeChats, RoutingNumberLookupRequestSupportedPaymentTypeCheck, RoutingNumberLookupRequestSupportedPaymentTypeCrossBorder, RoutingNumberLookupRequestSupportedPaymentTypeDkNets, RoutingNumberLookupRequestSupportedPaymentTypeEft, RoutingNumberLookupRequestSupportedPaymentTypeGBFps, RoutingNumberLookupRequestSupportedPaymentTypeMasav, RoutingNumberLookupRequestSupportedPaymentTypeMxCcen, RoutingNumberLookupRequestSupportedPaymentTypeNeft, RoutingNumberLookupRequestSupportedPaymentTypeNics, RoutingNumberLookupRequestSupportedPaymentTypeNzBecs, RoutingNumberLookupRequestSupportedPaymentTypePlElixir, RoutingNumberLookupRequestSupportedPaymentTypeRtp, RoutingNumberLookupRequestSupportedPaymentTypeSeBankgirot, RoutingNumberLookupRequestSupportedPaymentTypeSepa, RoutingNumberLookupRequestSupportedPaymentTypeSgGiro, RoutingNumberLookupRequestSupportedPaymentTypeSic, RoutingNumberLookupRequestSupportedPaymentTypeStablecoin, RoutingNumberLookupRequestSupportedPaymentTypeWire, RoutingNumberLookupRequestSupportedPaymentTypeZengin:
		return true
	}
	return false
}
