...
func TestInternalAccountNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.InternalAccounts.New(context.TODO(), moderntreasury.InternalAccountNewParams{
    ...
    AccountCapabilities: moderntreasury.F([]moderntreasury.InternalAccountNewParamsAccountCapability{moderntreasury.InternalAccountNewParamsAccountCapability{
...
func TestInternalAccountRequestClosure(t *testing.T) {
  baseURL := "http://localhost:4010"
  if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
    baseURL = envURL
  }
  ...
  _, err := client.InternalAccounts.RequestClosure(context.TODO(), "id")
  if err != nil {
    var apierr *moderntreasury.Error
    if errors.As(err, &apierr) {
      t.Log(string(apierr.DumpRequest(true)))
...
func TestInternalAccountUpdateAccountCapability(t *testing.T) {
  baseURL := "http://localhost:4010"
  if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
    baseURL = envURL
  }
  ...
  _, err := client.InternalAccounts.UpdateAccountCapability(
    context.TODO(),
    "internal_account_id",
    "id",
