...
func TestVirtualAccountNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.VirtualAccounts.New(context.TODO(), moderntreasury.VirtualAccountNewParams{
		...
		AccountDetails: moderntreasury.F([]moderntreasury.AccountDetailParam{{
			...
			AccountNumberType: moderntreasury.F(moderntreasury.AccountDetailAccountNumberTypeClabe),
			AccountNumberSafe: moderntreasury.F("string"),
		}, {
			ID:                moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			Object:            moderntreasury.F("string"),
			LiveMode:          moderntreasury.F(true),
		...
		RoutingDetails: moderntreasury.F([]moderntreasury.RoutingDetailParam{{
			ID:                moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			Object:            moderntreasury.F("string"),
			LiveMode:          moderntreasury.F(true),
			CreatedAt:         moderntreasury.F(time.Now()),
			...
			RoutingNumberType: moderntreasury.F(moderntreasury.RoutingDetailRoutingNumberTypeAba),
			PaymentType:       moderntreasury.F(moderntreasury.RoutingDetailPaymentTypeACH),
			BankName:          moderntreasury.F("string"),
			BankAddress: moderntreasury.F(moderntreasury.RoutingDetailBankAddressParam{
				ID:         moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				Object:     moderntreasury.F("string"),
				LiveMode:   moderntreasury.F(true),
				CreatedAt:  moderntreasury.F(time.Now()),
...
func TestVirtualAccountGet(t *testing.T) {
	...
	err := client.VirtualAccounts.Get(context.TODO(), "string")
	if err != nil {
		var apierr *moderntreasury.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
