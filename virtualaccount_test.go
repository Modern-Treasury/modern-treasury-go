...
func TestVirtualAccountUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := c.VirtualAccounts.Update(
		context.TODO(),
		"string",
		moderntreasury.VirtualAccountUpdateParams{Name: moderntreasury.F("string"), CounterpartyID: moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"), Metadata: moderntreasury.F(map[string]string{"foo": "string"})},
	)
	if err != nil {
		var apierr *moderntreasury.Error
		if errors.As(err, &apierr) {
