...
func TestExpectedPaymentNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.ExpectedPayments.New(context.TODO(), moderntreasury.ExpectedPaymentNewParams{
    ...
    AmountReconciled: moderntreasury.F(int64(0)),
    AmountReconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentNewParamsAmountReconciledDirectionCredit),
    AmountUnreconciled: moderntreasury.F(int64(0)),
    AmountUnreconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentNewParamsAmountUnreconciledDirectionCredit),
    ...
    LineItems: moderntreasury.F([]moderntreasury.ExpectedPaymentNewParamsLineItem{moderntreasury.ExpectedPaymentNewParamsLineItem{
      Amount: moderntreasury.F(int64(0)),
    ...
    ReconciliationRuleVariables: moderntreasury.F([]moderntreasury.ReconciliationRuleParam{moderntreasury.ReconciliationRuleParam{
      AmountLowerBound: moderntreasury.F(int64(0)),
      AmountUpperBound: moderntreasury.F(int64(0)),
...
func TestExpectedPaymentUpdateWithOptionalParams(t *testing.T) {
  ...
  _, err := client.ExpectedPayments.Update(
    ...
    moderntreasury.ExpectedPaymentUpdateParams{
      AmountLowerBound: moderntreasury.F(int64(0)),
      AmountReconciled: moderntreasury.F(int64(0)),
      AmountReconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentUpdateParamsAmountReconciledDirectionCredit),
      AmountUnreconciled: moderntreasury.F(int64(0)),
      AmountUnreconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentUpdateParamsAmountUnreconciledDirectionCredit),
      AmountUpperBound: moderntreasury.F(int64(0)),
      CounterpartyID: moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
      Currency: moderntreasury.F(shared.CurrencyAed),
      DateLowerBound: moderntreasury.F(time.Now()),
