...
func TestExpectedPaymentNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ExpectedPayments.New(context.TODO(), moderntreasury.ExpectedPaymentNewParams{
		ExpectedPaymentCreate: moderntreasury.ExpectedPaymentCreateParam{
			AmountLowerBound:            moderntreasury.F(int64(0)),
			AmountReconciled:            moderntreasury.F(int64(0)),
			AmountReconciledDirection:   moderntreasury.F(moderntreasury.ExpectedPaymentCreateAmountReconciledDirectionCredit),
			AmountUnreconciled:          moderntreasury.F(int64(0)),
			AmountUnreconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentCreateAmountUnreconciledDirectionCredit),
			...
			Direction:                   moderntreasury.F(moderntreasury.ExpectedPaymentCreateDirectionCredit),
...
func TestExpectedPaymentUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ExpectedPayments.Update(
		...
		moderntreasury.ExpectedPaymentUpdateParams{
			ExpectedPaymentUpdate: moderntreasury.ExpectedPaymentUpdateParam{
				AmountLowerBound:            moderntreasury.F(int64(0)),
				AmountReconciled:            moderntreasury.F(int64(0)),
				AmountReconciledDirection:   moderntreasury.F(moderntreasury.ExpectedPaymentUpdateAmountReconciledDirectionCredit),
				AmountUnreconciled:          moderntreasury.F(int64(0)),
				AmountUnreconciledDirection: moderntreasury.F(moderntreasury.ExpectedPaymentUpdateAmountUnreconciledDirectionCredit),
				AmountUpperBound:            moderntreasury.F(int64(0)),
				CounterpartyID:              moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				Currency:                    moderntreasury.F(shared.CurrencyAed),
				DateLowerBound:              moderntreasury.F(time.Now()),
				DateUpperBound:              moderntreasury.F(time.Now()),
				Description:                 moderntreasury.F("description"),
				Direction:                   moderntreasury.F(moderntreasury.ExpectedPaymentUpdateDirectionCredit),
				ExternalID:                  moderntreasury.F("external_id"),
				InternalAccountID:           moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				Metadata: moderntreasury.F(map[string]string{
					"key":    "value",
				...
				RemittanceInformation: moderntreasury.F("remittance_information"),
				StatementDescriptor:   moderntreasury.F("statement_descriptor"),
				Status:                moderntreasury.F(moderntreasury.ExpectedPaymentUpdateStatusReconciled),
				Type:                  moderntreasury.F(moderntreasury.ExpectedPaymentTypeACH),
			},
		},
	)
