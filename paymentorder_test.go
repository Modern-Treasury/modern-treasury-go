...
func TestPaymentOrderNewWithOptionalParams(t *testing.T) {
  ...
  _, err := client.PaymentOrders.New(context.TODO(), moderntreasury.PaymentOrderNewParams{
    ...
    Documents: moderntreasury.F([]moderntreasury.PaymentOrderNewParamsDocument{moderntreasury.PaymentOrderNewParamsDocument{
    ...
    LedgerTransaction: moderntreasury.F(shared.LedgerTransactionCreateRequestParam{
      LedgerEntries: moderntreasury.F([]shared.LedgerEntryCreateRequestParam{shared.LedgerEntryCreateRequestParam{
    ...
    LineItems: moderntreasury.F([]moderntreasury.PaymentOrderNewParamsLineItem{moderntreasury.PaymentOrderNewParamsLineItem{
      Amount: moderntreasury.F(int64(0)),
    ...
    ReceivingAccount: moderntreasury.F(moderntreasury.PaymentOrderNewParamsReceivingAccount{
      AccountDetails: moderntreasury.F([]moderntreasury.PaymentOrderNewParamsReceivingAccountAccountDetail{moderntreasury.PaymentOrderNewParamsReceivingAccountAccountDetail{
      ...
      RoutingDetails: moderntreasury.F([]moderntreasury.PaymentOrderNewParamsReceivingAccountRoutingDetail{moderntreasury.PaymentOrderNewParamsReceivingAccountRoutingDetail{
    ...
    UltimateOriginatingAccountID: moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
    UltimateOriginatingPartyAddress: moderntreasury.F(moderntreasury.PaymentOrderNewParamsUltimateOriginatingPartyAddress{
      Country: moderntreasury.F("country"),
      Line1: moderntreasury.F("line1"),
      Line2: moderntreasury.F("line2"),
      Locality: moderntreasury.F("locality"),
...
func TestPaymentOrderUpdateWithOptionalParams(t *testing.T) {
  ...
  _, err := client.PaymentOrders.Update(
    ...
    moderntreasury.PaymentOrderUpdateParams{
      ...
      LineItems: moderntreasury.F([]moderntreasury.PaymentOrderUpdateParamsLineItem{moderntreasury.PaymentOrderUpdateParamsLineItem{
        Amount: moderntreasury.F(int64(0)),
        AccountingCategoryID: moderntreasury.F("accounting_category_id"),
        Description: moderntreasury.F("description"),
        Metadata: moderntreasury.F(map[string]string{
      ...
      ReceivingAccount: moderntreasury.F(moderntreasury.PaymentOrderUpdateParamsReceivingAccount{
        AccountDetails: moderntreasury.F([]moderntreasury.PaymentOrderUpdateParamsReceivingAccountAccountDetail{moderntreasury.PaymentOrderUpdateParamsReceivingAccountAccountDetail{
          AccountNumber: moderntreasury.F("account_number"),
        ...
        PlaidProcessorToken: moderntreasury.F("plaid_processor_token"),
        RoutingDetails: moderntreasury.F([]moderntreasury.PaymentOrderUpdateParamsReceivingAccountRoutingDetail{moderntreasury.PaymentOrderUpdateParamsReceivingAccountRoutingDetail{
          RoutingNumber: moderntreasury.F("routing_number"),
...
func TestPaymentOrderNewAsyncWithOptionalParams(t *testing.T) {
  ...
  _, err := client.PaymentOrders.NewAsync(context.TODO(), moderntreasury.PaymentOrderNewAsyncParams{
    ...
    LedgerTransactionID: moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
    LineItems: moderntreasury.F([]moderntreasury.PaymentOrderNewAsyncParamsLineItem{moderntreasury.PaymentOrderNewAsyncParamsLineItem{
      Amount: moderntreasury.F(int64(0)),
      AccountingCategoryID: moderntreasury.F("accounting_category_id"),
      Description: moderntreasury.F("description"),
      Metadata: moderntreasury.F(map[string]string{
    ...
    ReceivingAccount: moderntreasury.F(moderntreasury.PaymentOrderNewAsyncParamsReceivingAccount{
      AccountDetails: moderntreasury.F([]moderntreasury.PaymentOrderNewAsyncParamsReceivingAccountAccountDetail{moderntreasury.PaymentOrderNewAsyncParamsReceivingAccountAccountDetail{
        AccountNumber: moderntreasury.F("account_number"),
      ...
      PlaidProcessorToken: moderntreasury.F("plaid_processor_token"),
      RoutingDetails: moderntreasury.F([]moderntreasury.PaymentOrderNewAsyncParamsReceivingAccountRoutingDetail{moderntreasury.PaymentOrderNewAsyncParamsReceivingAccountRoutingDetail{
        RoutingNumber: moderntreasury.F("routing_number"),
    ...
    TransactionMonitoringEnabled: moderntreasury.F(true),
    UltimateOriginatingAccountID: moderntreasury.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
    UltimateOriginatingPartyAddress: moderntreasury.F(moderntreasury.PaymentOrderNewAsyncParamsUltimateOriginatingPartyAddress{
      Country: moderntreasury.F("country"),
      Line1: moderntreasury.F("line1"),
      Line2: moderntreasury.F("line2"),
      Locality: moderntreasury.F("locality"),
