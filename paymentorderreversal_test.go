...
func TestPaymentOrderReversalListWithOptionalParams(t *testing.T) {
	...
	_, err := c.PaymentOrders.Reversals.List(
		context.TODO(),
		"string",
		moderntreasury.PaymentOrderReversalListParams{AfterCursor: moderntreasury.F("string"), PerPage: moderntreasury.F(int64(0))},
	)
	if err != nil {
		var apierr *moderntreasury.Error
		if errors.As(err, &apierr) {
