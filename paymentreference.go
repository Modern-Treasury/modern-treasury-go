...
const (
	...
	PaymentReferenceReferenceNumberTypeMtFofTransferID                                PaymentReferenceReferenceNumberType = "mt_fof_transfer_id"
